    ...
    >
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 2px 8px rgba(45,76,205,0.12)',
          cursor: 'pointer',
        }}
      >
        ...
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0, overflow: 'visible', animation: 'durIconEnter 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) both' }}>
          ...
          <g style={{ animation: 'durStarTwinkle1 2s ease-in-out infinite', animationDelay: '0.4s' }}>
            <path d="M19 15L19.9 17.1L22 18L19.9 18.9L19 21L18.1 18.9L16 18L18.1 17.1L19 15Z" fill="#2D4CCD" opacity="0.6" />
          </g>
          <g style={{ animation: 'durStarTwinkle2 2s ease-in-out infinite', animationDelay: '0.8s' }}>
            <path d="M5 3L5.7 4.8L7.5 5.5L5.7 6.2L5 8L4.3 6.2L2.5 5.5L4.3 4.8L5 3Z" fill="#2D4CCD" opacity="0.4" />
          </g>
        </svg>
        ...
        <span
          style={{
            fontSize: 13,
            fontWeight: 600,
            backgroundImage: 'linear-gradient(90deg, #2D4CCD 0%, #7B5CF5 50%, #2D4CCD 100%)',
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="9" stroke="#2D4CCD" strokeWidth="1.8" />
              <path d="M12 7v5l3 3" stroke="#2D4CCD" strokeWidth="1.8" strokeLinecap="round" />
            </svg>
            ...
            {TIMELINE_ITEMS.map((item, i) => (
              <div key={i} style={{ display: 'flex', gap: 12, position: 'relative' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0, width: 10 }}>
                  <div style={{ width: 10, height: 10, borderRadius: '50%', border: '2px solid #2D4CCD', background: '#fff', flexShrink: 0 }} />
                ...
                <div style={{ display: 'flex', gap: 10, paddingBottom: i < TIMELINE_ITEMS.length - 1 ? 10 : 0, alignItems: 'flex-start' }}>
                  <span style={{ fontSize: 13, fontWeight: 600, color: '#2D4CCD', fontFamily: "'Poppins', sans-serif", minWidth: 58 }}>
                    {item.time}
                  </span>
