    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#EAEDFA', gap: 8, position: 'relative' }}>
        ...
        <div style={{ flex: 1, background: 'white', borderRadius: '16px 16px 0 0', boxShadow: SHADOW_EL16, overflowY: 'auto', padding: '0 24px 96px' }}>
          ...
          {/* Note Type */}
          <AcFormField key={summaryRule?.noteType ? 'locked-note' : 'note'} label="Note Type:" defaultValue="DAP Note" options={['DAP Note', 'SOAP Note', 'Progress Note', 'Treatment Plan', 'Intake Note', 'BPS Assessment']} compactMode={compactMode} forcedValue={summaryRule?.noteTypeLabel} disabled={!!summaryRule?.noteType} />
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#EAEDFA', gap: 8, position: 'relative' }}>
      ...
      <div style={{ flex: 1, background: 'white', borderRadius: '16px 16px 0 0', boxShadow: SHADOW_EL16, overflowY: 'auto', padding: '0 24px 96px' }}>
        ...
        {/* Session Type */}
        <AcFormField key={rule?.sessionType ? 'locked-session' : (isGroup ? 'group' : 'individual')} label="Session Type:" defaultValue={isGroup ? 'Group Therapy' : 'Individual Therapy'} options={['Individual Therapy', 'Group Therapy', 'Family Therapy', 'Couples Therapy', 'Case Management', 'BPS Assessment']} compactMode={compactMode} forcedValue={rule?.sessionType} disabled={!!rule?.sessionType} />
        ...
        {/* Note Type */}
        <AcFormField key={rule?.noteType ? 'locked-note' : 'note'} label="Note Type:" defaultValue={rule?.noteTypeLabel ?? 'DAP Note'} options={['DAP Note', 'SOAP Note', 'Progress Note', 'Treatment Plan', 'BPS Assessment']} compactMode={compactMode} forcedValue={rule?.noteTypeLabel} disabled={!!rule?.noteType} />
