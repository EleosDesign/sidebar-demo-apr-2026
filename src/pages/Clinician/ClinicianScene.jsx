      ...
      >
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', width: 52, height: 52, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            ...
            <div style={{ position: 'absolute', top: 0, right: 0, width: 20, height: 20, borderRadius: '50%', background: '#ef4444', border: `2px solid ${smartScribeColor(smartScribeSkin)}`, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 4 }}>
              {lqaStatus === 'loading' ? (
                <>
